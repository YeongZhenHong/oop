...
class BotAPI:
    ...
    # def insertReddit(self, comment, upvotes, date, time):
    #     """! Insert Reddit
    ...
    # def insertYahoo(self, title, source, date, description, link):
    #     """! Insert Yahoo
    ...
    def readCsv(self, platform, socialMedia):
        ...
        """
        try:
            df = pd.read_csv("./CSV/"+platform+"_+"+socialMedia+"+.csv", usecols=[
